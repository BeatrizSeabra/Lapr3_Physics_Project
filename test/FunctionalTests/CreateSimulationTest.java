...
public class CreateSimulationTest {
	...
	private CreateSimulationController createSimulationController;
	...
	public CreateSimulationTest() {
		...
		this.filePathSimulation = "test/Files/SimulationXMLTest.xml";
	...
	/**
	 * Test functional of functionality, of class CreateSimulationController.
	 */
	@Test
