...
public class GraphTest {
	...
	public void testVertices() {
		...
		assertTrue("first vertice should be vert1", (itVerts.next().
				   equals(vert1) == true));
		assertTrue("second vertice should be vert2", (itVerts.next().
				   equals(vert2) == true));

		instance.removeVertex("A");

		itVerts = instance.vertices().iterator();
		assertTrue("first vertice should now be vert2", (itVerts.next().
				   equals(vert2)) == true);
	...
	public void testGetEdge() {
		...
		assertTrue("edge should be edge3", instance.getEdge(vert2, vert4).
				   equals(edge3) == true);
		...
		assertTrue("edge should be edge8", instance.getEdge(vert5, vert5).
				   equals(edge8) == true);
	}
	...
	public void testOutgoingEdges() {
		...
		Iterator<Edge<String, String>> itEdge = instance.outgoingEdges(vert3).
			iterator();
	...
	public void testIncomingEdges() {
		...
		Iterator<Edge<String, String>> itEdge = instance.incomingEdges(vert4).
			iterator();
	...
	public void testClone() {
		...
		assertTrue("number of vertices should be equal", instance.numVertices() == instClone.
				   numVertices());
		assertTrue("number of edges should be equal", instance.numEdges() == instClone.
				   numEdges());

		//vertices should be equal
		Iterator<Vertex<String, String>> itvertClone = instClone.vertices().
			iterator();
		Iterator<Vertex<String, String>> itvertSource = instance.vertices().
			iterator();
		while (itvertSource.hasNext()) {
			assertTrue("vertices should be equal ", (itvertSource.next().
	...
	public void testEquals() {
		...
		assertTrue("should be equal to a clone", instance.equals(instance.
				   clone()));

		Graph<String, String> other = instance.clone();
		Edge<String, String> edge = other.getEdge(other.getVertex("E"), other.
												  getVertex("E"));
		other.removeEdge(edge);
		assertFalse("instance should not be equal to other", instance.
					equals(other));
