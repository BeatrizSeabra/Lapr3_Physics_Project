 ...
 */
public class FastPathAnalysisTest {
	...
	/**
	 * Test of getName method, of class FastPathAnalysis.
	 */
	@Test
	public void testGetName() {
		System.out.println("getName");
		FastPathAnalysis instance = new FastPathAnalysis();
		String expResult = "Fast Path Analysis";
	...
	public void testAnalyze() {
		...
		FastPathAnalysis instance = new FastPathAnalysis();
		List<String[]> data = new FastPathAnalysis().
		...
		String expResult = "NameLenghtTotalNoden00,00 kmSegment0120,00 km0,00 kmNoden220,00 km";
