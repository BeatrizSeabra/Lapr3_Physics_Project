...
public class EconomicVehicleAnalysisTest {
	...
	public EconomicVehicleAnalysisTest() {
	...
	/**
	 * Test of getName method, of class EconomicVehicleAnalysis.
	 */
	@Test
	public void testGetName() {
		System.out.println("getName");
		EconomicVehicleAnalysis instance = new EconomicVehicleAnalysis();
		String expResult = "Economic Vehicle Analysis";
	...
	/**
	 * Test of analyze method, of class EconomicVehicleAnalysis.
	 */
	@Test
	public void testAnalyze() {
		System.out.println("testanalyze");

		List<String[]> data = new EconomicVehicleAnalysis().
